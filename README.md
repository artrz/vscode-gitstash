...
| `gitstash.explorer.items.stash.popAndApply`               | `pop`                                                               | Defines if pop or apply will be set as item button (and the secondary action as context menu option) |
| `gitstash.explorer.items.stash.diffButton`                | `changes-current`                                                   | Defines which comparison to display from a file diff button |
...
| `gitstash.advanced.repositorySearchDepth`                 | `1`                                                                 | Search depth for finding repositories on subdirectories. If value is negative parent directory repositories will be searched |
